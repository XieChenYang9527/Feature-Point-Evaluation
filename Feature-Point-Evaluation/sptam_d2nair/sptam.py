...
from dataset import TartanAirOdometry
from params import ParamsTantarair
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, help='dataset (KITTI/EuRoC/Tartanair)',
                        default='Tartanair')
    parser.add_argument('--path', type=str, help='dataset path',
                        default='/home/xcy/air/P016')
    ...
    if args.dataset.lower() == 'kitti':
        ...
        params = ParamsTantarair()
        dataset = TartanAirOdometry(args.path)
    ...
    save_traj("/home/xcy/Desktop/air/d2n/16.txt", global_pose, format='tum')
    sptam.stop()
    if visualize:
        viewer.stop()